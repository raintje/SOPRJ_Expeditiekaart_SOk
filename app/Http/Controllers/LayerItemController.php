        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    return " <div  class='d-flex'> <a  href='" . route('edit.item', $row->id) . "' style='min-width:65px; ' class='mw-100 btn btn-success btn-xs pl-2'>Edit</a><a style='min-width:65px; margin-left:4px'  href='" . route('show.item', $row->id) ."' class=' btn btn-info btn-xs pl-2'>Bekijken</a></div>";
                })
