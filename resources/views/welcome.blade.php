...
<nav class="Nav--right">
    <div class="Dropdown">
        <button aria-label="Menu">
            <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" enable-background="new 0 0 515.555 515.555" height="512"
                 viewBox="0 0 515.555 515.555" width="512">
                <path
        ...
        <div class="Dropdown">
            <a href="#" aria-label="Account">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                     id="Capa_1" x="0px" y="0px" viewBox="0 0 460.8 460.8"
                     style="enable-background:new 0 0 460.8 460.8;" xml:space="preserve">
	<g>
        <path
          ...
          Account
            ...
            <a aria-label="Dashboard">
                <svg xmlns="http://www.w3.org/2000/svg" id="Bold" enable-background="new 0 0 24 24" height="512"
                    ...
                    <path
                        d="m1.75 24h7.5c.965 0 1.75-.785 1.75-1.75v-12.5c0-.965-.785-1.75-1.75-1.75h-7.5c-.965 0-1.75.785-1.75 1.75v12.5c0 .965.785 1.75 1.75 1.75z"/>
                    <path
